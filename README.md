# corndog
The future of arbitrary playlist generation.

But in all reality, this project uses the Spotify Web API to analyze your library and allow you to generate new
playlists with custom amounts of
 - acousticness
 - danceability
 - instrumentalness
 - liveness
...
all based on the music you know and love!

**NOTE: We used a starter pack to generate this project.  The extensive documentation below was not written by us.**
